...
На данный момент я работаю на позиции Junior QA Engineer в Elefanto Digital Studio. 
Мы работаем над самыми разнообразными проектами, и, конечно, во всех них есть баги и иные интересные моменты.

Я связан NDA, но кое-какие моменты могу показать ;)
